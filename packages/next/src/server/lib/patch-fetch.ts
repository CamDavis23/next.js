      ...
      async () => {
        ...
        if (
          ...
          (workUnitStore.type === 'prerender' ||
            ...
            // we know the fetch will be dynamic for cacheComponents so we
            ...
            .then(async (res) => {
              ...
              if (
                ...
                if (
                  ...
                  // We are prerendering at build time or revalidate time with cacheComponents so we need to
        ...
        if (cacheKey && incrementalCache) {
          ...
          if (isCacheableRevalidate && !cachedFetchData) {
            ...
            if (hasNoExplicitCacheConfig) {
              ...
              // In these cases we want to make sure we still exclude them from prerenders if cacheComponents is on
